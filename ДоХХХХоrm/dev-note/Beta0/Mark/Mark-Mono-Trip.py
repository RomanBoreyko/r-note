...
Участники: "Марк, Орф, хвост, Времяед, Мимики, Суфлеры, Трагики, Ящики, Пауки, Инквизитор, Следак, Оператор."
...
1. Импульс.  
    ...
    "Крючок-наживка(Провокация)" 
        ...
        {
            Начальство нашло спрос и предложило решение. Работу курьера для Марка. Преобразование Марка в генератор мемасиков для Хоста.
        }
